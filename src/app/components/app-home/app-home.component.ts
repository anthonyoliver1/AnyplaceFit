...
export class AppHomeComponent implements OnInit {
  ...
  listPersonals: any = [
    ...
    {verify: false, email: "belleprofessora@hotmail.com",    name: "Isabelle Martins",  sexo: "F", age: 24, number: "(39) 97151-4960", local: "Veredinha - MG",           isWhatsApp: true,  area: 'Musculação',        image: "../../../assets/images/prof_isabella.png",  description: "Olá me chamo Isabelle Martins,  tenho 24 anos e sou  faixa preta ex judoca representante do Batalhão da Polícia, dou aulas de Musculação com o objetivo de repassar o conhecimento da arte suave para crianças e adultos."},
